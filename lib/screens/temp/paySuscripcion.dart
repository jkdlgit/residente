...
class _InAppState extends State<InApp> {
  ...
  final List<String> _susLists = Platform.isAndroid
      ? [
  ...
  Future _getSuscription() async {
    List<IAPItem> items =
        await FlutterInappPurchase.instance.getSubscriptions(_susLists);
    for (var item in items) {
      print('${item.toString()}');
      this._items.add(item);
    }
                      ...
                      children: <Widget>[
                        Container(
                            ...
                            child: FlatButton(
                              ...
                              onPressed: () {
                                print(
                                    "---------- Get Suscriptions Button Pressed");
                                this._getSuscription();
                              },
                              child: Container(
                                padding: EdgeInsets.symmetric(horizontal: 20.0),
